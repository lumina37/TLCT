...
namespace tcfg = tlct::cfg::tspc::v2;
...
std::unique_ptr<tcfg::ParamConfig> TestTSPCCfg_v2::param_cfg_ = nullptr;
std::unique_ptr<tcfg::CalibConfig> TestTSPCCfg_v2::calib_cfg_ = nullptr;
std::unique_ptr<tcfg::Layout> TestTSPCCfg_v2::layout_ = nullptr;
